  ...
  return createElement('div', null,
    ...
    createElement('div', { className: 'section' },
      ...
      createElement('div', { className: 'features-grid' },
        ...
        featureCard('Server-Side Rendering',
          'renderToString, renderToPipeableStream, and renderToReadableStream with progressive chunked output.'),
        featureCard('Hash-Based Router',
          'Built-in SPA routing with Router, Route, Link, useParams, and useNavigate.'),
        featureCard('Hydration',
          'hydrateRoot reuses existing server-rendered DOM nodes — no flash of re-rendered content.'),
